...
<html lang="en">
	...
	<head>
        ...
        <title>Beranda Artikel Kemahasiswaan</title>
    ...
    <div class="container">
        ...
        <div class="justify-content-center" style="margin: 5px;">
                ...
                <br>
                <div class="row ">
                    <div class="shop-item-price"><?php echo $post["ket"];?></div>
                </div>
                
                
                <!-- <div class="col-lg-3 col-sm-12">
                    <span class="shop-item-title"><?php echo $post["nama"];?></span>
                    <img class="shop-item-image" src="<?= base_url(); ?>assets/arum/img/<?php echo $post["gambar"];?>">
                    <div class="shop-item-details">
                        <span class="shop-item-price"><?php echo $post["ket"];?></span>
