...
<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-2 px-lg-6 navbar-light bg-white shadow-sm">
    ...
    <div class="row justify-content-center mt-8">
		<div class="col-md-4">
			<h1 class="h3 my-3 fw-normal text-center">Selamat Datang Kembali</h1>
			<?php
			...
			<div class="form-floating mb-2">
				<input type="password" name="password" class="form-control" id="password" value="<?php echo set_value('password'); ?>" placeholder="password" autofocus required>
				<label for="password">Password</label>
				<?php echo form_error('username'); ?>
			</div>

			<button class="w-100 btn btn-lg btn-primary" type="submit" name="btnSubmit" value="Login" >Login</button>
